...
from app.endpoints.workspace_user_invite_endpoints import workspace_invite_pre_request
...
class PreRequestRegistrer:
    ...
    def _register_user_checks(self):
        """Register pre-request checks specific to user endpoints."""

        self.app.before_request(user_pre_request)

    def _register_invite_checks(self):
        """Register pre-request checks specific to invite endpoints."""

        self.app.before_request(workspace_invite_pre_request)
